...
function New-CaseSandbox {
    ...
    foreach ($file in @('install.ps1', 'permission-request.js', 'session-teardown.js', 'Gdip_All.ahk', 'press-1.ico', 'codex-permission-request.js', 'codex-reviewer.js', 'merge-hooks.js', 'merge-codex-hooks.js')) {
